# 🚌 Routify — developer guide

Running Routify, how it's built, its security, the driver and depot tools, and its known limits.
For what Routify is and why, start with the [README](../README.md).
...
Every transit app struggles here for two reasons — **mountains block GPS** and **the network disappears**. Routify is designed around that instead of pretending otherwise.
